...
export default function Restock() {
  ...
  return (
    // Penyesuaian di sini:
    // Menambahkan `pt-16` (padding-top) dan `lg:pl-64` (padding-left)
    // Angka-angka ini adalah contoh dan perlu disesuaikan dengan tinggi header dan lebar sidebar Anda.
    <div className="p-6 pt-16 lg:pl-64">
